...
const CameraStream = () => {
  ...
  const markedBeepSet = useRef(new Set()); 
    ...
    <div className="camera-stream-container">
      ...
      <div className="controls-container">
        ...
        <div className="attendance-status-container">
          ...
          {Object.entries(attendance).map(([name, attendanceStatus]) => (
            <p
              key={name}
              className={
                lastValidStatus[name] === "Unknown"
                  ? "attendance-status unknown" // Apply red color for "Unknown"
                  : "attendance-status valid" // Apply green color for valid attendance
              }
            >
        ...
        <div>
          <Button
            ...
            style={{ width: "100%" }} // Ensure button takes full width in smaller screens
          >
            End Session
          </Button>
        </div>
